...
public class Covid19Controller {
    ...
    private static String covidStatusAPI = "https://api.covid19india.org/v2/state_district_wise.json";
    private static String dailyConfirmedCase = "https://api.covid19india.org/states_daily_csv/confirmed.csv";
    private static String dailyDeceasedCase = "https://api.covid19india.org/states_daily_csv/deceased.csv";
    private static String dailyRecoveredCase = "https://api.covid19india.org/states_daily_csv/recovered.csv";
    ...
    public ModelAndView fetchCovidStatusStateWise(Model model) {
        ...
        return new ModelAndView("covid19Status");
    }
